...
export default function PortfolioPage() {
  ...
  const liveProjects = mockProjects.filter(p => 
    ["paul-precious-wedding", "color-powder-festival", "fca-krakow-basketball", "krakow-portrait-sessions", "krakow-motocross-highlights", "football-game-coverage"].includes(p.slug)
  );
