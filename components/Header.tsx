      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link href="/book" className="px-4 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-500/10 transition-colors">
              Book
            </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {isLoading ? (
              ...
              <>
                ...
                <Link href="/book" className="px-5 py-2.5 text-sm font-semibold text-white bg-slate-900 dark:bg-white dark:text-slate-900 rounded-lg hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors">
                  Book Us
                </Link>
              </>
            ) : (
              <>
                {(role === "team" || role === "admin") && (
                  <Link href="/dashboard" className="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors">
                    Dashboard
                  </Link>
                )}
                <Link href="/portal" className="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors">
                  Portal
                </Link>
                <Link href="/book" className="px-5 py-2.5 text-sm font-semibold text-white bg-slate-900 dark:bg-white dark:text-slate-900 rounded-lg hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors">
                  Book Us
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-slate-200 dark:border-slate-800">
            <div className="flex flex-col gap-1">
              ...
              <Link href="/book" className="px-4 py-3 text-base font-medium text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-lg transition-colors" onClick={() => setMobileMenuOpen(false)}>
                Book
              </Link>
              {role === "admin" && (
              ...
              {!session ? (
                <>
                  ...
                  <Link href="/book" className="mx-4 mt-2 px-4 py-3 text-base font-semibold text-white bg-slate-900 dark:bg-white dark:text-slate-900 rounded-lg text-center hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors" onClick={() => setMobileMenuOpen(false)}>
                    Book Us
                  </Link>
                </>
              ) : (
                <>
                  {(role === "team" || role === "admin") && (
                    <Link href="/dashboard" className="px-4 py-3 text-base font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors" onClick={() => setMobileMenuOpen(false)}>
                      Dashboard
                    </Link>
                  )}
                  <Link href="/portal" className="px-4 py-3 text-base font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors" onClick={() => setMobileMenuOpen(false)}>
                    Portal
                  </Link>
                  <Link href="/book" className="mx-4 mt-2 px-4 py-3 text-base font-semibold text-white bg-slate-900 dark:bg-white dark:text-slate-900 rounded-lg text-center hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors" onClick={() => setMobileMenuOpen(false)}>
                    Book Us
